...
$format = get_field('format'); // Adjust 'format' according to your ACF field name

// Retrieve taxonomy terms for the current post
$terms = get_the_terms(get_the_ID(), 'format'); // Replace 'your_taxonomy_slug' with your actual taxonomy slug
